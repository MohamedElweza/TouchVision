...
class _HomeState extends State<Home> {
  ...
  void playHomeAudio(String audioFile)
  {
  ...
  void initState() {
    ...
    if (isArabicMode)
    {
      playHomeAudio("arabicHomeIntro.mp3");
      playHomeAudio("arabicHomeIntro_2.mp3");
    }
    else
    {
      playHomeAudio("englishHomeIntro.mp3");
      playHomeAudio("englishHomeIntro_2.mp3");
    }
